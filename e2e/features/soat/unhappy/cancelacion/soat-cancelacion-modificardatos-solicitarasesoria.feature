Feature: Pruebas happy con mocks para cancelar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Cancelacion][ModificarDatos][Happy] :: Cancelar seguros SOAT y presionar el botón modificar datos y solicitar asesoria
    ...
    And en la pantalla "Modificar datos" de cancelación de SOAT se presiona el botón "Solicitar asesoria"
    And se abre el aplicativo de llamadas con el numero telefónico "01 5135000"
