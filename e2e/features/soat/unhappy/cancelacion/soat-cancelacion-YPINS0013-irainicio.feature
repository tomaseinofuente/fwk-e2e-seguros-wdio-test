Feature: Pruebas unhappy con mocks para cancelar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Cancelacion][OTP][unHappy] :: Cancelación luego de 15 días de compra de poliza - YPINS0013 - Ir a inicio
    ...
    And al presionar el botón "Ir a inicio" se debe volver al menú principal
