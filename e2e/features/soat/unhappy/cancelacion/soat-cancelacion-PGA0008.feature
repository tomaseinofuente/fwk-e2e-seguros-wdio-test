Feature: Pruebas unhappy con mocks para cancelar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Cancelacion][OTP][unHappy] :: Solicitud de cancelación en proceso - PGA0008 - Cerrar
    ...
    Then Se debería mostrar el modal con el título "Cancelación en proceso"
    And como mensaje "La cancelación de tu SOAT está en proceso y esto podría tomar hasta 2 días hábiles."
