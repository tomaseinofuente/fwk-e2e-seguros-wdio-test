Feature: Pruebas unhappy con mocks para cancelar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Cancelacion][OTP][unHappy] :: No puede anular porque ya uso SOAT - PGA0007 - Llamar a Pacífico
    ...
    Then Se debería mostrar el modal con el título "No pudimos procesar la cancelación de tu SOAT"
    And como mensaje "Para más información comunicate con Pacífico al 513-5000, opción 4."
