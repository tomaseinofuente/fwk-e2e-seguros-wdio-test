Feature: Pruebas unhappy con mocks para Comprar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Comprar][UnHappy] :: Error De Datos Al Comprar seguros SOAT En Pacifico - MNK0025
    ...
    Examples:
      ...
      |    001 | real_main_psp_201_soat_precio_minimo | psp_422_payment_method_not_included_list |       |
