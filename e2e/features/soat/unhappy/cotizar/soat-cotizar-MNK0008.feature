# Datadog muestra el codigo de error TL9999 business-account
Feature: Pruebas unhappy con mocks para Cotizar seguros SOAT en Yape

  Scenario Outline: <codigo>-[SOAT][Cotizar][UnHappy] :: Error De Datos Al Cotizar seguros SOAT En Pacifico - MNK0008
    ...
    Examples:
      ...
      |    001 | psp_422_channel_format |       |
      # |    002 | psp_422_channel_invalid |       |
