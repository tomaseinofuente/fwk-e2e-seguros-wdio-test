Feature: Pruebas unhappy con mocks para Cotizar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Cotizar][UnHappy] :: Error De Datos Al Cotizar seguros SOAT En Pacifico - MNK0005
    ...
    Examples:
      ...
      |    001 | psp_422_first_name_length       |       |
      # |    002 | psp_422_last_name_length        |       |
      # |    003 | psp_422_second_last_name_length |       |
