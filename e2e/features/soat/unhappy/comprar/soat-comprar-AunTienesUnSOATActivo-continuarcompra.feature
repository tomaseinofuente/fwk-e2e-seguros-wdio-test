Feature: Pruebas unhappy con mocks para Comprar seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][Comprar][UnHappy] :: Comprar un seguro SOAT, para un SOAT activo, cuando la fecha de activación sea dentro de 90 días y presionar Continuar compra
    ...
    And al presionar el botón "Continuar compra" se cierra el modal y se muestra la pantalla de ingreso de codigo OPT para continuar con la compra
