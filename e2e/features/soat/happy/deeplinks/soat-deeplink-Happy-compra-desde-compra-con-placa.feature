Feature: Prueba con deeplink de seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][deeplink][Happy] :: redirigir a la pantalla de compra con la placa establecida en el deeplink y comprar un SOAT
    And establecemos el personality <personalityInicial>
    When con el deeplink <deeplink> con numero de <placa>
    ...
    Examples:
      | codigo | deeplink                          | placa | personalityInicial                   | numDecimales |
      |    001 | yape://yape.com.pe/app/soat/quote |       | real_main_psp_201_soat_precio_minimo |            2 |
