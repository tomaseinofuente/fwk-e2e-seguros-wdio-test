Feature: Prueba con deeplink de seguros SOAT en Yape
  ...
  Scenario Outline: <codigo>-[SOAT][deeplink][Happy] :: redirigir a la pantalla de menú de mundo seguros con el deeplink y comprar un SOAT
    ...
    Examples:
      ...
      |    001 | yape://yape.com.pe/app/soat | real_main_psp_201_soat_precio_minimo |       |            2 |
