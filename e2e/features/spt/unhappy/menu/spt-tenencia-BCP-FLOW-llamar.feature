...
Está casuística se presenta cuando se presiona el botón "Dinero más seguro" en el menú de mundo seguros
  ...
  Scenario Outline: <codigo>-[SPT][Tenencia][UnHappy] :: Usuario ya tiene activado un seguro con el BCP - Flow = BCP-LLAMAR
    ...
    And al presionar el botón "Llamar" se abre el aplicativo de llamadas con el numero telefónico "01 3119898"
