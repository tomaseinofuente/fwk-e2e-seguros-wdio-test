...
Está casuística se presenta cuando se presiona el botón "Dinero más seguro" en el menú de mundo seguros
  ...
  Scenario Outline: <codigo>-[SPT][Tenencia][UnHappy] :: Error De Datos Al Consultar Tenencia De Seguro En Pacifico - MNK2001
    ...
    Examples:
      ...
      |    001 | psp_422_tenancy_not_inclusion_list         |
      # |    002 | psp_422_tenancy_document_number_required   |
      # |    003 | psp_422_tenancy_document_type_required     |
      # |    004 | psp_422_tenancy_document_number_format_dni |
      # |    005 | psp_422_tenancy_product_code_required      |
      # |    006 | psp_422_tenancy_product_code_format        |
