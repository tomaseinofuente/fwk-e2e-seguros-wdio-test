...
Está casuística se presenta cuando se presiona el botón "Dinero más seguro" en el menú de mundo seguros
  ...
  Scenario Outline: <codigo>-[SPT][Tenencia][UnHappy] :: Error De Datos Al Consultar Tenencia De Seguro En Pacifico - MNK0016
    ...
    Examples:
      ...
      |    001 | psp_503_tenancy_service_unavailable |
