...
Está casuística se presenta cuando se presiona el botón "comprar seguro" en la pantalla de seguro cotizado
  ...
  @android
  Scenario Outline: <codigo>-[SPT][Comprar][UnHappy] :: Error De Datos Al Confirmar la compra de Seguro En Pacifico - MNK0003
    ...
    Examples:
      ...
      |    001 | real_email         | psp_500_internal_server_error |
