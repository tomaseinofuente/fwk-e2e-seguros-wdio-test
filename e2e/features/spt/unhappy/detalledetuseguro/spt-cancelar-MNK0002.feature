...
Está casuística se presenta cuando se presiona el botón "Cancelar seguro" en la pantalla de detalle de tu seguro
  ...
  Scenario Outline: <codigo>-[SPT][Cancelar][UnHappy] :: Error De Datos Al Cancelar la compra de un Seguro En Pacifico - MNK0002
    ...
    Examples:
      ...
      |    001 | psp_200_flow_post_sale_psp_401_cancel_unauthorized |
