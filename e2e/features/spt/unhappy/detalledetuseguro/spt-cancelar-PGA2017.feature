...
Está casuística se presenta cuando se presiona el botón "Cancelar seguro" en la pantalla de detalle de tu seguro
  ...
  Scenario Outline: <codigo>-[SPT][Cancelar][UnHappy] :: Error De Datos Al Cancelar la compra de un Seguro En Pacifico - PGA2017
    ...
    Then Se debería mostrar el modal con el título "Solicitud de cancelación en proceso"
    And como mensaje "Pronto recibirás la confirmación de cancelación a tu correo."
    ...
    Examples:
      ...
      |    001 | psp_200_flow_post_sale_psp_422_pacifico_cancel_in_process |
